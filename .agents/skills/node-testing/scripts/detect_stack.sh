...
grep -q '"schemathesis"' package.json && echo "  FOUND: Schemathesis"
grep -q '"dredd"' package.json && echo "  FOUND: Dredd (legacy -- match if already present, Schemathesis is the current recommendation for a new setup)"
